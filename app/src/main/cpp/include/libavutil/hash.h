 ...
 * concealment to internal regression testing. include.libavutil has efficient
 ...
 * An abstraction layer for all hash functions supported by include.libavutil.
 *
 ...
 * reusable API for @ref lavu_hash "all hash functions" implemented in include.libavutil.
 ...
 * include.libavutil without recompilation.
 *
 * @warning
