 ...
 *      include.libavcodec exports generic options, while its priv_data field exports
 ...
 * Such structs in FFmpeg are e.g. AVCodecContext in include.libavcodec or
 * AVFormatContext in include.libavformat.
 *
